...
import json
import pandas as pd
patch_directory = "patches/patches_entropy_petke_8h_deduplicated"
patches_list = []
...
plt.savefig("analysis_notebooks/plots/petke_tested_ranking_edelta.pdf")
...
def classification(df, prior_tool, cutoff):
    ...
    csv_path = f"entropy_analysis_petke_cutoff_{cutoff}.csv"
