...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Train and evaluate patch correctness models.")
    parser.add_argument('--dataset', choices=['petke', 'repairllama'], required=True,
    ...
    if args.dataset == 'petke':
        directory_path = '../../../datasets/petke/patches_by_time/patches_8h_deduplicated'
        output_csv = f"patch_results_petke_{algorithm}.csv"
    else:
        directory_path = '../../../datasets/repairllama/context_size_3_filtered'
        output_csv = f"patch_results_repairllama_{algorithm}.csv"
