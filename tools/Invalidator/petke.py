...
project_root = "../../defects4j_projects/petke"
invariants_dir = "petke_data/processed_data/invariants"
log_path = "compile_failures.log"

# Add directories for patch data
patch_invariants_dir = os.path.join(invariants_dir, "patches")
patch_info_dir = "petke_data/raw_data/patch_info"
patch_meta_dir = os.path.join(patch_info_dir, "petke_patches")
