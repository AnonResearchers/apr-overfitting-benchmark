...
_PROCESSED_DATA_DIR = "repairllama_data/processed_data/"
_RAW_DATA = "repairllama_data/raw_data/"
...
_INFO_PATH = _RAW_DATA + "patch_info/repairllama_patches/{}.json"

with open('repairllama_data/raw_data/patch_info/patch_number_to_filename.json', 'r') as f:
...
def main():
    ...
    csv_path = 'repairllama_results.csv'
    ...
    for patch in list_patches:
        ...
        csv_writer.writerow([patch_name, correctness, prediction])
    csv_file.close()
    total_runtime = time.time() - st_time
    with open("repairllama_runtime.txt", "w") as runtime_file:
        runtime_file.write(f"Total time: {total_runtime}\n")
